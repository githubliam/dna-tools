...
func RegisterGovernance() {
	...
	core.OntTool.RegMethod("AssignDnaIDsToRole", AssignDnaIDsToRole)
	core.OntTool.RegMethod("AssignDnaIDsToRoleAny", AssignDnaIDsToRoleAny)
	...
	core.OntTool.RegMethod("ForceQuitNode", BlackNode)
	core.OntTool.RegMethod("WhiteNode", WhiteNode)
	core.OntTool.RegMethod("SwitchEpoch", CommitDpos)
